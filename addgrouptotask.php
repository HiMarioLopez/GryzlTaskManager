 ...
 <div class="container-fluid bg">
  <div class="d-flex p-4">
    <div class="card mx-auto my-auto bg-dark text-light">
      <div class="card-body">
        <h4 class="card-title">Set a Group</h4>
        ...
        <h3>Assign groups to task "<?php echo $_COOKIE["current_task"] ?>"</h3>
          <form action="./php/addgrouptotask_action.php" method="post">
            ...
            <input id="gname" class="form-control" type="text" name="newGroup" maxlength="50"><br></p>
            <input class="btn" type="submit" name="tonext" value="Add another group">
          </form>
          ...
          <h3><br>Groups Already Tagged:</h3>
